...
export default function Hero(){
    const items = [
        {
            ...
            content: 'Toko Elektronik Digital di Kota Palembang',
            addition: <button className="btn rounded-r-full glass text-white max-sm:self-end">Get Started</button>,
        ...
        },
        {
            ...
            content: 'Kami menyediakan berbagai promo menarik setiap Bulannya',
            addition: <button className="btn rounded-r-full glass text-white max-sm:self-end">Check it Out!</button>,
    ...
    return(
        ...
        className={`hero glass min-h-screen ${slider === 'right' ? 'animate-slideRight' : 'animate-slideLeft'} transition-all duration-[1200] ${items[pages].background}`}
        >
        <div className="hero-overlay bg-transparent"></div>
        <div className="flex flex-col gap-10">
            <div className="hero-content w-full relative max-sm:flex-col max-sm:gap-20 md:justify-between justify-evenly text-neutral-content text-center">
                ...
                <div className="content-text items-end max-sm:items-center max-sm:order-2 flex flex-col gap-5 p-5 max-sm:px-20 max-sm:w-full w-[80%]">
                    <p className="font-black text-xl md:text-4xl glass font-[Outfit] bg- p-2 rounded-full sm:rounded-r-none md:self-end text-nowrap px-5">{items[pages].title}</p>
                    <p className="text-justify">{items[pages].content}</p>
