...
export default function CheckoutPage(){
  return(
        <section className="min-h-screen text-neutral/60 grid md:grid-cols-[1fr_0.5fr] xl:grid-cols-[1fr_0.3fr] gap-4 md:p-5 p-2 md:w-[90%] w-full place-self-center mt-15">
